...
class SkillsWidget extends StatefulWidget {
  final double headingFontSize = 48;

  const SkillsWidget({super.key});

  @override
  _SkillsWidgetState createState() => _SkillsWidgetState(headingFontSize: headingFontSize);
}

class _SkillsWidgetState extends State<SkillsWidget> {
  final double headingFontSize;

  _SkillsWidgetState({required this.headingFontSize});
            ...
            child: Row(
              ...
              children: <Widget>[
                Expanded(
                  flex: 1,
                  child: Padding(
                    padding: EdgeInsets.only(bottom: 50.0, left: MediaQuery.of(context).size.width * 0.06),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      mainAxisSize: MainAxisSize.min,
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: <Widget>[
                        _buildSkillsList(context, headingFontSize: MediaQuery.of(context).size.width * 0.012),
                        SizedBox(height: MediaQuery.of(context).size.height * 0.03),
                        _buildEducation(headingFontSize: MediaQuery.of(context).size.width * 0.012),
                      ],
                    ),
                  ),
                ),
                Expanded(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      _buildSkills(fontSize: MediaQuery.of(context).size.width * 0.12),
                      const CircleWidget(
                        width: 60,
                        height: 60,
                        outerRadius: 25.0,
...
//            left: MediaQuery.of(context).size.height * 0.10,
          ...
          child: Padding(
            ...
            child: Center(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  _buildSkills(fontSize: MediaQuery.of(context).size.width * 0.23),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.03),
              ...
              children: <Widget>[
                Column(
                  ...
                  children: <Widget>[
                    _buildSkills(fontSize: MediaQuery.of(context).size.width * 0.23),
                    SizedBox(height: MediaQuery.of(context).size.height * 0.03),
                    _buildEducation(headingFontSize: headingFontSize),
                    SizedBox(height: MediaQuery.of(context).size.height * 0.03),
                    _buildSkillsList(context, headingFontSize: headingFontSize),
                  ],
                ),
  ...
  Widget _buildSkills({required double fontSize}) {
    return RichText(
      text: TextSpan(
        text: Strings.skills,
  ...
  Widget _buildSkillsList(BuildContext context, {required double headingFontSize}) {
  ...
  Widget _buildEducationTile(WorkExperience education, {required double headingFontSize}) {
    return Padding(
