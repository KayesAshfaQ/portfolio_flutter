...
class _HireWidgetState extends State<HireWidget> {
  ...
  Widget _buildLargeScreenContent(BuildContext context) {
    return Stack(
      children: <Widget>[
        ResponsiveWidget.isLargeScreen(context) ? _buildHire() : const SizedBox.shrink(),
        Positioned(
                  ...
                  child: Padding(
                    ...
                    child: Wrap(
                      children: <Widget>[
                        ...
                        _buildHireSummary(fontSize: MediaQuery.of(context).size.width * 0.06),
                      ],
                    ),
                  ),
                ),
          ...
          child: Padding(
            ...
            child: Center(
              child: Column(
                ...
                children: <Widget>[
                  _buildHireSummary(fontSize: MediaQuery.of(context).size.width * 0.10),
            ...
            children: [
              TextSpan(
                ...
                style: TextStyles.sub_heading.copyWith(
                  ...
                  decoration: _hovering ? TextDecoration.none : TextDecoration.lineThrough,
                ),
              )
            ],
          ),
